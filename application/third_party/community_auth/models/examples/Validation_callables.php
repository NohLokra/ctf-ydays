...
class Validation_callables extends MY_Model {
	...
	public function _check_password_strength( $password )
	{
		...
		if( config_item('max_chars_for_password') > 0 )
			$error .= '<li>Moins de ' . config_item('max_chars_for_password') . ' caractères</li>';
		...
		if( config_item('min_lowercase_chars_for_password') > 0 )
		{
			...
			$error .= '<li>' . config_item('min_lowercase_chars_for_password') . ' lettre' . $plural . ' en minuscules</li>';
		}
		...
		if( config_item('min_uppercase_chars_for_password') > 0 )
		{
			...
			$error .= '<li>' . config_item('min_uppercase_chars_for_password') . ' lettre' . $plural . ' en majuscules</li>';
		}
		...
		if( config_item('min_non_alphanumeric_chars_for_password') > 0 )
		{
			...
			$error .= '<li>' . config_item('min_non_alphanumeric_chars_for_password') . ' caractère' . $plural . ' spéciaux</li>';
		}
